...
$reports = [];
$filter_status = $_GET['filter_status'] ?? 'all'; // 'all', 'new', 'viewed', 'resolved'
$sort_order = $_GET['sort'] ?? 'newest'; // 'newest', 'oldest'
    ...
    <div class="container">
        <nav>
            <div>
                ...
                <a href="manage_player_reports.php" class="active-nav">Reportes do Player</a> <!-- Link Ativo -->
